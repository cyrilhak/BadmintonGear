<?php
  ...
  define('HTTPS_SERVER', 'http://192.168.178.31');
  define('ENABLE_SSL', false);
  define('HTTP_COOKIE_DOMAIN', '');
  define('HTTPS_COOKIE_DOMAIN', '');
  define('HTTP_COOKIE_PATH', '/badmintongear/');
  define('HTTPS_COOKIE_PATH', '/badmintongear/');
  define('DIR_WS_HTTP_CATALOG', '/badmintongear/');
  define('DIR_WS_HTTPS_CATALOG', '/badmintongear/');
